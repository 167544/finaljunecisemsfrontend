...
>
  Reset
         ...
         <div style={{ display: 'flex', marginLeft: 'auto ' }}>
          <div style={{ height: "110px", boxShadow: "4px 7px 22px -7px", fontFamily: 'sans-serif', fontSize: '2rem', color: '#003C51' }}>
      ...
      <div>
        ...
        <div style={{ margin: '1rem' }}>
          <div style={{ display: 'flex', justifyContent: 'start', gap: '1rem', flexWrap: 'wrap', }}>
            <div className='mb-5' style={{ display: 'flex', backgroundColor: "white", borderRadius: "5px", boxShadow: "4px 7px 22px -7px" }}>
              {boxes.map((box, index) => (

                <div key={index} style={{ width:'200px', padding: '0.5rem', borderRadius: '4px', backgroundColor: `${box.color}`, textAlign: 'center', cursor: 'pointer', margin: "1rem", }} onClick={() => handleBoxClick(box.title)}>
